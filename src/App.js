...
const App = () => {
  ...
  const configId = '69169f59-7028-44e4-bb03-4b84e1608f2f';
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-2xl bg-white rounded-3xl overflow-hidden shadow-lg">
        <div className="bg-gray-50 text-gray-800 p-4 text-xl font-semibold flex justify-center items-center border-b border-gray-200">
          <span>CS Dojo</span>
        </div>
        <div className="p-6 relative" style={{ minHeight: '500px' }}>
          <div className={`space-y-6 transition-all duration-500 ${isCallActive ? 'opacity-0 absolute inset-0 pointer-events-none' : 'opacity-100'}`}>
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="PetLab">PetLab</option>
                  <option value="NativePath">Upgraded Formulas</option>
                </select>
                <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400">▼</span>
              </div>
            </div>
            <div>
              <label htmlFor="customerProfile" className="block text-sm font-medium text-gray-700 mb-1">Customer Profile</label>
              <div className="relative">
                <select
                  id="customerProfile"
                  value={selectedCustomerProfile}
                  onChange={(e) => setSelectedCustomerProfile(e.target.value)}
                  className="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 rounded-md appearance-none bg-white"
                  disabled={isCallActive}
                >
                  <option value="Angry about returning foot massagers">Angry about returning foot massagers</option>
            ...
            <div>
              <label htmlFor="returnReason" className="block text-sm font-medium text-gray-700 mb-1">Return Reason</label>
              <div className="relative">
                <select
                  id="returnReason"
